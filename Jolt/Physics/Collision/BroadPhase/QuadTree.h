...
public:
	...
	/// Get bodies intersecting with an anti sphere in ioCollector (everything outside a sphere)
	void                        CollideAntiSphere(Vec3Arg inCenter, float inRadius, CollideShapeBodyCollector& ioCollector, const ObjectLayerFilter& inObjectLayerFilter, const TrackingVector& inTracking) const;
