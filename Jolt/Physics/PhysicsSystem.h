...
public:
	...
	void						DrawBody(const BodyManager::DrawSettings& inSettings, DebugRenderer* inRenderer, JPH::BodyID id) { mBodyManager.Draw(inSettings, mPhysicsSettings, inRenderer, &mBodyManager.GetBody(id)); }
