...
void PhysicsSystem::ProcessBodyPair(ContactAllocator &ioContactAllocator, const BodyPair &inBodyPair)
{
	...
	bool swap_motionType = body1->GetMotionType() < body2->GetMotionType();
	bool swap_id = (body1->GetMotionType() == body2->GetMotionType() && inBodyPair.mBodyB < inBodyPair.mBodyA);
	if (swap_motionType || swap_id)
		swap(body1, body2);
