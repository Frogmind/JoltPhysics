...
public:
	...
	inline void				AddForce(Vec3Arg inForce)										{
		...
		JPH_ASSERT(isfinite(mMotionProperties->mForce.x));
		JPH_ASSERT(isfinite(mMotionProperties->mForce.y));
		JPH_ASSERT(isfinite(mMotionProperties->mForce.z));
		JPH_ASSERT(!inForce.IsNaN());
	...
	inline void				AddTorque(Vec3Arg inTorque)										{
		JPH_ASSERT(IsDynamic());
		JPH_ASSERT(isfinite(mMotionProperties->mTorque.x));
		JPH_ASSERT(isfinite(mMotionProperties->mTorque.y));
		JPH_ASSERT(isfinite(mMotionProperties->mTorque.z));
		JPH_ASSERT(!inTorque.IsNaN());
